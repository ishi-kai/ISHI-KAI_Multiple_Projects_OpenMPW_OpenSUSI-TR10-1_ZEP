...
C {MP.sym} 390 -540 0 0 {name=M1 model=PMOS w=1600u l=2u nrd=0 nrs=0 m=1 spiceprefix=X}
C {MN.sym} 390 -380 0 0 {name=M2 model=NMOS w=680u l=2u nrd=0 nrs=0 m=1 spiceprefix=X}
